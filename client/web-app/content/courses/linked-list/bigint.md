...
Now at this point, you might ask yourself, who needs numbers bigger than this? Well, probably not you, but we're going to learn how it works anyway.
...
## Multiplication:
When implementing multiplication, I highly recommend drawing diagrams or writing out the examples by hand. I think getting a good visual here is super important.
...
The function above is more pseudo-code-oriented, so keep in mind that this is not a complete solution. Again, if you want to check out the source code, it is linked above!
